...
- 当前已推送文档提交 / `origin/main`：`cbe9f37c8e77a809ac03a8a7da06c06bcf05106e`；后续提交状态以 Git 实际结果为准。
...
- M5 预部署提交 `c6f40ca` 与使用清单提交 `cbe9f37` 的 GitHub Actions 全部通过；Actions 运行时依赖已继续升级到官方 Node 24 版本并固定完整 SHA，等待对应 CI 复核。
